...
import { projectQuery, type IProjectQuery } from '@/utils/supabaseQueries'

const router = useRoute('/projects/[slug]')
const slug = computed(() => (router.params as { slug?: string }).slug ?? '')
const project = ref<IProjectQuery | null>(null)
...
const getProject = async () => {
  const { data, error } = await projectQuery(slug.value)
